            ...
            <div className="space-x-4 flex items-center">
                {barMode ? (
                    <>
                        ...
                        <button
                            className="bg-[#8be9fd] hover:bg-[#ff79c6] px-4 py-2 rounded-lg cursor-pointer transition"
                            onClick={onExplorer}
                        >
                            Explorer
                        </button>
                    ...
                    <button
                        className="bg-[#6272a4] hover:bg-[#ff79c6] px-4 py-2 rounded-lg cursor-pointer transition"
                        onClick={onExplorer}
                    >
                        Console
                    </button>
