...
function Topbar({onFileUpload, onRun}: TopbarProps) {
    ...
    return (
        <nav className="bg-[#282a36] text-white p-4 shadow-lg flex justify-between items-center">
            ...
            <div className="space-x-4 flex items-center">
                <button
                    onClick={onRun}
                    className="bg-[#6272a4] hover:bg-[#50fa7b] px-4 py-2 rounded-lg cursor-pointer transition">
                    Run
                </button>
                <input
                    type="file"
                ...
                <button className="bg-[#ff5555] hover:bg-[#ff79c6] px-4 py-2 rounded-lg transition">
                    Clear
                </button>
            </div>
        </nav>
